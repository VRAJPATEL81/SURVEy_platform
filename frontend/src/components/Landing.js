          ...
          <div className="col s12">
            <div className="card z-depth-0">
              <div className="card-content">
                ...
                <p>
                  Anyone can fill the available survey form and give opinion about the product. To
                  create your own survey you need to create an account.
                </p>
              </div>
            </div>
            <div className="card z-depth-5" style={{ marginTop: "100px" }}>
              <div className="card-content">
                <span className="card-title">List of available surveys.</span>
